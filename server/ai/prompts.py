...
- title, channel_id — строго из EPG (channel_id из метки id=…);
...
- title, channel_id — verbatim from the EPG (channel_id from the id=… marker);
...
• title, channel_id — дословно из контекста.
...
• title, channel_id — verbatim from context.
