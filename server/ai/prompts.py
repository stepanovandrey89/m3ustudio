...
poster_keywords — КЛЮЧЕВАЯ подсказка для поиска постера. Формат:
• ЗАРУБЕЖНЫЙ фильм с русским дублированным названием:
  ОБЯЗАТЕЛЬНО латиница с оригинальным названием + год + «film».
  Примеры: «Шаровая молния» → «Thunderball 1965 film»; «Крепкий
  орешек» → «Die Hard 1988 film»; «Начало» → «Inception 2010 film»;
  «Остин Пауэрс: Похитители времени» → «Austin Powers 1999 film».
  БЕЗ оригинального названия Wikipedia/TMDB вернут не то (мультфильм
  про физическое явление вместо Бонда).
• РУССКИЙ фильм: на кириллице с суффиксом (фильм) или (сериал).
  Примеры: «Панчер» → «Панчер (фильм)»; «В баню!» → «В баню! (фильм)»;
  «Кухня» → «Кухня (телесериал)». Без суффикса ru.wiki отдаёт
  disambiguation-страницу без картинки.
• СЕРИАЛ зарубежный: «Severance TV series», «House of Cards series».
• СПОРТ: название команд или лиги — «Real Madrid vs Barcelona»,
  «NHL Capitals Penguins», «Formula 1 Monaco Grand Prix».
• новости/прочее: пустая строка.

CamelCase / слитные слова ЗАПРЕЩЕНЫ — TMDB их плохо ищет. Разделяй
слова ПРОБЕЛАМИ.
"""
