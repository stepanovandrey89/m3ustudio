...
const translations: Record<Lang, Record<string, string>> = {
  en: {
    ...
    'ai_deep_prompt': 'Tell me what you\'re after — an event, a team, a date. I\'ll scan the next 7 days of EPG and come back with channels and start times.',
  ...
  ru: {
    ...
    'ai_deep_prompt': 'Опиши что ищешь — событие, команду, дату. Я пробегусь по EPG на 7 дней вперёд и верну каналы и время начала.',
