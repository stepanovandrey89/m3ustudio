...
const translations: Record<Lang, Record<string, string>> = {
  en: {
    ...
    'ai_deep_prompt': 'Deep search is on — I now see 7 days of EPG. Ask anything specific (event, team, date); the mode stays active for follow-ups until you switch it off with × or clear the chat.',
    'ai_deep_placeholder': 'e.g. "Champions League next Tuesday"',
    'ai_deep_badge': 'Deep search',
    ...
    'digest_ready': 'Picks updated',
    'digest_ready_open': 'Open',
    'digest_failed': 'Refresh failed',
    'digest_empty': 'Nothing matches this theme today.',
    'digest_watch': 'Plan to watch',
    'digest_watch_now': 'Watch now',
    'digest_aired': 'Already aired',
    ...
    'archive_finalising': 'Finalising…',
    'digest_generating': 'Generating the digest in the background — this may take up to a minute.',
  ...
  ru: {
    ...
    'ai_deep_prompt': 'Глубокий поиск включён — теперь вижу 7 дней EPG. Спрашивай конкретное (событие, команда, дата); режим останется на все последующие вопросы, пока не выключишь его крестиком или не очистишь чат.',
    'ai_deep_placeholder': 'например: «Лига чемпионов во вторник»',
    'ai_deep_badge': 'Глубокий поиск',
    ...
    'digest_ready': 'Подборка обновлена',
    'digest_ready_open': 'Открыть',
    'digest_failed': 'Не удалось обновить',
    'digest_empty': 'По этой теме сегодня ничего.',
    'digest_watch': 'Хочу посмотреть',
    'digest_watch_now': 'Смотреть сейчас',
    'digest_aired': 'Уже прошло',
    ...
    'archive_finalising': 'Завершается…',
    'digest_generating': 'Подбираю дайджест в фоне — это займёт до минуты.',
